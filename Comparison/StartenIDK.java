...
public class StartenIDK {
    ...
    public static void main(String[] args) {
        ...
        int[] werteIS;
        int[] schrittWerteMS = new int[anzahlArrays];
        int[] vertauschWerteMS = new int[anzahlArrays];
        int[] werteMS;
        int median = (anzahlArrays / 2) - 1;
        System.out.println("Anfang"+java.util.Arrays.toString(schrittWerteIS));
        for (int i = 0; i < anzahlArrays; i++) {
            ...
            werteMS = MergeSort.sort(arr6, 0, größeArray - 1);
            schrittWerteMS[i] = werteMS[0];
            vertauschWerteMS[i] = werteMS[1];
           // System.out.println("Werte MS von Durchgang "+i+"!: "+java.util.Arrays.toString(werteMS));

        }

     //// System.out.println("verschrittwerte is"+java.util.Arrays.toString(vertauschWerteIS));
